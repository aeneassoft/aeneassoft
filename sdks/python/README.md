...
One line of init. Every LLM call — from every library — is traced, attributed, and visible in your AeneasSoft dashboard.
...
Every span includes `compliance_flags: ["eu_ai_act_art12_relevant"]` where applicable. Use the AeneasSoft dashboard to generate a Readiness Score and Article 12/13 compliance report.
