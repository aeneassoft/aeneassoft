...
//   import { init, trace, span } from '@aeneassoft/sdk-node';
//   init({ apiKey: 'your-key' });
...
export function init(options: InitOptions): void {
  const { apiKey, ingestUrl = 'https://api.aeneassoft.com/api/ingest', zeroDataRetention = false } = options;
