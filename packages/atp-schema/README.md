...
[![npm version](https://badge.fury.io/js/%40productname%2Fatp-schema.svg)](https://www.npmjs.com/package/@aeneassoft/atp-schema)
...
```bash
npm install @aeneassoft/atp-schema zod
```
...
```typescript
import { ATPSpanSchema, type ATPSpan } from '@aeneassoft/atp-schema';
...
This schema is the open-source core of AeneasSoft, an Agent Observability platform.
