"""
[PRODUCTNAME] Stress Test — Massenhafte Span-Ingestion
...
def main():
    parser = argparse.ArgumentParser(description="[PRODUCTNAME] Ingest Stress Test")
    ...
    print(f"\n[PRODUCTNAME] Ingest Stress Test")
    print(f"{'=' * 50}")
