"""
AeneasSoft Stress Test — ClickHouse direkte Abfragen
...
def main():
    parser = argparse.ArgumentParser(description="AeneasSoft ClickHouse Stress Test")
    parser.add_argument("--url", default=DEFAULT_CH_URL)
    parser.add_argument("--db", default=DEFAULT_DB)
    args = parser.parse_args()

    print(f"\nAeneasSoft ClickHouse Stress Test")
    print(f"{'=' * 60}")
