"""
AeneasSoft Stress Test — Out-of-Order Spans (Orphan Buffer)
...
def main():
    parser = argparse.ArgumentParser(description="AeneasSoft Orphan Buffer Stress Test")
    ...
    print(f"\nAeneasSoft Orphan Buffer Stress Test")
    print(f"{'=' * 50}")
